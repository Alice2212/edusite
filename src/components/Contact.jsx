...
const Contact = () => {
  return (
    <section className="w-full h-[15rem] bg-[--raisin-black] ">
      <div className="container flex flex-wrap mx-auto py-24 relative overflow-y-hidden z-10">
        ...
        <div className="absolute left-[70%] top-[25%] 	z-20 lg:visible md:invisible sm:invisible ">
          <img
            src={contactBanner}
            alt=""
